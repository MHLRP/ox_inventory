return {
	...
	["tiemeupwires"] = {
		...
		stack = true,
		close = true,
		description = "Copper wires tied into a heart from the Vanilla Unicorn kitchen.",
		client = {
	...
	["byte_menu"] = {
		label = "Niche Byte Apex Menu",
		weight = 5,
		stack = true,
		close = true,
		description = "Niche Byte Apex Menu.",
	},
	...
	["beekeeper_suit"] = {
		...
		close = true,
		description =
		"A full veil and coveralls. Use to put it on or take it off. Wild bees cannot sting you while it is on.",
	},
	...
	['neuralnetgreens'] = {
		...
		stack = true,
		close = true,
		description = 'Scrap metal, cyber nuts, and cyber oil. Built for cyborgs.',
		client = {
			status = { hunger = 55 },
			prop = {
				[1] = {
	...
	["vanillacarbonmilkshake"] = {
		label = "Vanilla Carbon Milkshake",
		weight = 350,
		stack = true,
		close = true,
		client = { image = "vanillacarbonmilkshake.png" },
	},
	["thedoubletap"] = {
	...
	["systemoverload"] = {
		...
		stack = true,
		close = true,
		client = { image = "systemoverload.png" },
	},
	["staticcola"] = {
		label = "Static Cola",
		weight = 350,
		stack = true,
		close = true,
		client = { image = "staticcola.png" },
	},
	["rexsunit01burger"] = {
		label = "Rex's Unit 01 Burger",
		weight = 400,
		stack = true,
		close = true,
		client = { image = "rexsunit01burger.png" },
	},
	["neonapplepie"] = {
		label = "Neon Apple Pie",
		weight = 250,
		stack = true,
		close = true,
		client = { image = "neonapplepie.png" },
	},
	["midnightpattymelt"] = {
		label = "Midnight Patty Melt",
		weight = 400,
		stack = true,
		close = true,
		client = { image = "midnightpattymelt.png" },
	},
	["griddlefriedporkchop"] = {
		label = "Griddle Fried Pork Chop",
		weight = 450,
		stack = true,
		close = true,
		client = { image = "griddlefriedpork chop.png" },
	},
	["ghostsignal"] = {
		label = "Ghost Signal",
		weight = 350,
		stack = true,
		close = true,
		client = { image = "ghostsignal.png" },
	},
	["datarexcrunch"] = {
		label = "Data Rex Crunch",
		weight = 250,
		stack = true,
		close = true,
		client = { image = "datarexcrunch.png" },
	},
	["circuitboardnachos"] = {
		label = "Circuit Board Nachos",
		weight = 300,
		stack = true,
		close = true,
		client = { image = "circuitboardnachos.png" },
	},
	["chromeonionrings"] = {
		label = "Chrome Onion Rings",
		weight = 250,
		stack = true,
		close = true,
		client = { image = "chromeonion rings.png" },
	},
	["chocolatecarbonmilkshake"] = {
		label = "Chocolate Carbon Milkshake",
		weight = 350,
		stack = true,
		close = true,
		client = { image = "chocolatecarbonmilkshake.png" },
	},
	["chickenandwaffles"] = {
		...
		stack = true,
		close = true,
		client = { image = "chickenandwaffles.png" },
	},
	["bluescreenlemonade"] = {
		label = "Blue Screen Lemonade",
		weight = 350,
		stack = true,
		close = true,
		client = { image = "bluescreenlemonade.png" },
	},
	["allnighter"] = {
		label = "All Nighter",
		weight = 400,
		stack = true,
		close = true,
		client = { image = "allnighter.png" },
	},
	["blackoutfries"] = {
		label = "Blackout Fries",
		weight = 250,
		stack = true,
		close = true,
		client = { image = "blackoutfries.png" },
	},
	["diced_chicken"] = {
		label = "Diced Chicken",
		weight = 200,
	...
	["pickled_onions"] = {
		...
		stack = true,
		close = true,
		client = { image = "picked_onions.png" },
	},
	["fry_dust"] = {
		label = "Fry Dust",
		weight = 50,
	...
	["mashed_potatoes"] = {
		...
		stack = true,
		close = true,
		client = { image = "mashed_potatoes.png" },
	},
	["hash_browns"] = {
		label = "Hash Browns",
		weight = 150,
	...
	["apple_pie_filling"] = {
		...
		stack = true,
		close = true,
		client = { image = "apple_pie_filling.png" },
	},
	["citrus_glaze"] = {
		label = "Citrus Glaze",
		weight = 100,
