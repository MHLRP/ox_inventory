return {
	...
	GeneralStore = {
		...
		inventory = {
			...
			{ name = 'bandage',                price = 25,  count = 50,  currency = 'money' },
			...
			{ name = 'cigbox',                 price = 100, count = 40,  currency = 'money' },
	...
	GeneralStore2 = {
		...
		inventory = {
			...
			{ name = 'bandage',         price = 25,  count = 50 },
	...
	YouTool = {
		...
		inventory = {
			...
			{ name = 'slaptable',        price = 400,   count = 40,        currency = 'money' },
			...
			{ name = 'cane',             price = 250,   currency = 'money' },
			{ name = 'staff',            price = 250,   currency = 'money' },
			{ name = 'poster',           price = 400,   count = 40,        currency = 'money' },
			{ name = 'chalkboard1',      price = 200,   currency = 'money' },
			{ name = 'chalkboard2',      price = 200,   currency = 'money' },
			{ name = 'chalkboard3',      price = 200,   currency = 'money' },
			{ name = 'chalkboard4',      price = 200,   currency = 'money' },
			{ name = 'remove_poster',    price = 200,   currency = 'money' },
			...
			{ name = 'radio',            price = 100,   count = 50,        currency = 'money' },
			{ name = 'scrunchie',        price = 100,   count = 50,        currency = 'money' },
			{ name = 'rc-bandito',       price = 1200,  currency = 'money' },
			{ name = 'binoculars',       price = 100,   count = 50,        currency = 'money' },
			...
			{ name = 'fitbit',           price = 400,   count = 40,        currency = 'money' },
			...
			{ name = 'camera',           price = 200,   currency = 'money' },
			{ name = 'videocam',         price = 400,   count = 40,        currency = 'money' },
	...
	GroceryStore16 = {
		name = 'Grocery Store',
		inventory = {
			{ name = 'box_bourgeoix_liquor', price = 200, count = 40, currency = 'money' },
			{ name = 'box_cariaque_liquor',  price = 200, count = 40, currency = 'money' },
			{ name = 'box_bleuterd_liquor',  price = 200, count = 40, currency = 'money' },
			{ name = 'box_ragga_liquor',     price = 200, count = 40, currency = 'money' },
			{ name = 'box_tequilya_liquor',  price = 200, count = 40, currency = 'money' },
			{ name = 'box_nogo_liquor',      price = 200, count = 40, currency = 'money' },
			{ name = 'box_mount_liquor',     price = 200, count = 40, currency = 'money' },
			{ name = 'box_richards_liquor',  price = 200, count = 40, currency = 'money' },
		},
		locations = {
	...
	GroceryStore19 = {
		name = 'Grocery Store',
		inventory = {
			{ name = 'zatweednutrition', price = 200, count = 30, currency = 'money' },
		},
		locations = {
