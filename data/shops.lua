return {
	...
	Ammunation = {
		...
		locations = {
			...
			vec3(4021.1377, 6162.5659, 7.5574)
		},
		targets = {
			...
			{ ped = `s_m_y_ammucity_01`, scenario = 'WORLD_HUMAN_COP_IDLES', distance = 5.0, loc = vec3(4021.1377, 6162.5659, 6.5574),   heading = 267.3477 },
		}
	},
	...
	GeneralStore = {
		...
		inventory = {
			...
			{ name = 'strawberrysyrup',        price = 10,  currency = 'money' },
			{ name = 'tortillas',              price = 10,  currency = 'money' },
			{ name = 'taco-tomato',            price = 40,  currency = 'money' },
			{ name = 'lettuce',                price = 40,  currency = 'money' },
			{ name = 'snr_avocado',            price = 10,  currency = 'money' },
			{ name = 'capers',                 price = 10,  currency = 'money' },
			{ name = 'barra-manteiga',         price = 10,  currency = 'money' },
			{ name = 'chaispice',              price = 10,  currency = 'money' },
			...
			{ name = 'camelliatealeaves',      price = 15,  currency = 'money' },
			{ name = 'blacktealeaves',         price = 15,  currency = 'money' },
			{ name = 'greentealeaves',         price = 15,  currency = 'money' },
	...
	GeneralStore2 = {
		...
		locations = {
			...
			vec3(3958.6067, 5970.2490, 25.9748),
		...
		targets = {
			...
			{ loc = vec3(3951.2930, 5970.2822, 25.9745),  length = 1.5, width = 3.0, heading = 265.9390, minZ = 41.5, maxZ = 43.0, distance = 3 },
	...
	LTDGas = {
		...
		locations = {
			...
			vec3(4076.5840, 6544.3423, 6.9783)
		},
		targets = {
			...
			{ loc = vec3(4076.5840, 6544.3423, 6.9783), length = 1.5, width = 3.0, heading = 0.2255, minZ = 41.5, maxZ = 43.0, distance = 3 },
		}
	},
	...
	SmokeShop = {
		...
		inventory = {
			...
			{ name = 'zatweedseed',           price = 0, currency = 'money' },
			{ name = 'weedgrinder',           price = 0, currency = 'money' },
			{ name = 'dabrig',                price = 0, currency = 'money' },
	...
	SmokeShop2 = {
		...
		inventory = {
			{ name = 'zatrollingpaper', price = 5,   currency = 'money' },
	...
	WeedShop = {
		name = 'Weed Shop',
		inventory = {
			{ name = 'zatweedseed',   price = 3000, currency = 'money' },
			{ name = 'zatplanter',    price = 4000, currency = 'money' },
			-- { name = 'male_seed',          price = 3000, currency = 'money' }, hmm... not sure if we need this
			{ name = 'zatweedrackxs', price = 2500, currency = 'money' },
			{ name = 'zatweedracks',  price = 5000, currency = 'money' },
		},
		targets = {
			{
				ped = `a_f_y_hippie_01`,
	...
	YouTool = {
		...
		inventory = {
			...
			{ name = 'ball_1',           price = 50,    currency = 'money' },
			{ name = 'ball_2',           price = 50,    currency = 'money' },
			{ name = 'ball_3',           price = 50,    currency = 'money' },
			{ name = 'ball_4',           price = 50,    currency = 'money' },
			{ name = 'ball_5',           price = 50,    currency = 'money' },
			{ name = 'ball_6',           price = 50,    currency = 'money' },
			{ name = 'ball_7',           price = 50,    currency = 'money' },
			{ name = 'ball_8',           price = 50,    currency = 'money' },
			{ name = 'ball_9',           price = 50,    currency = 'money' },
			{ name = 'ball_10',          price = 50,    currency = 'money' },
			{ name = 'ball_11',          price = 50,    currency = 'money' },
			{ name = 'ball_12',          price = 50,    currency = 'money' },
			{ name = 'ball_13',          price = 50,    currency = 'money' },
			{ name = 'ball_14',          price = 50,    currency = 'money' },
			{ name = 'ball_15',          price = 50,    currency = 'money' },
			{ name = 'ball_16',          price = 50,    currency = 'money' },
			{ name = 'ball_17',          price = 50,    currency = 'money' },
			...
			{ name = 'videocam',         price = 400,   currency = 'money' },
	...
	GroceryStore2 = {
		...
		inventory = {
			...
			{ name = 'frozen_fillet_salmon',       price = 20, currency = 'money' },
			{ name = 'snr_bacon',                  price = 20, currency = 'money' },
	...
	GroceryStoreFront = {
		...
		inventory = {
			...
			{ name = 'softscoopmix',           price = 12,  currency = 'money' },
			{ name = 'smoothiemix',            price = 12,  currency = 'money' },
			{ name = 'matchapowder',           price = 10,  currency = 'money' },
			{ name = 'lavenderpowder',         price = 10,  currency = 'money' },
			{ name = 'vanilla',                price = 10,  currency = 'money' },
			{ name = 'mint',                   price = 8,   currency = 'money' },
			{ name = 'pistachio',              price = 6,   currency = 'money' },
			{ name = 'butterscotch',           price = 10,  currency = 'money' },
			...
			{ name = 'bagel',                  price = 10,  currency = 'money' },
			{ name = 'englishmuffin',          price = 10,  currency = 'money' },
			{ name = 'croissant',              price = 10,  currency = 'money' },
			{ name = 'italiansausage',         price = 20,  currency = 'money' },
			{ name = 'caixa-amoras',           price = 10,  currency = 'money' },
			{ name = 'marshmellow',            price = 10,  currency = 'money' },
			{ name = 'chocolate',              price = 10,  currency = 'money' },
			{ name = 'butter',                 price = 10,  currency = 'money' },
			{ name = 'creamcheese',            price = 10,  currency = 'money' },
			...
			{ name = 'mustard',                price = 10,  currency = 'money' },
			{ name = 'ketchup',                price = 10,  currency = 'money' },
			{ name = 'hollandaisesauce',       price = 5,   currency = 'money' },
			{ name = 'raw_meat',               price = 20,  currency = 'money' },
			{ name = 'veal_meat',              price = 20,  currency = 'money' },
			{ name = 'raw_shrimp',             price = 20,  currency = 'money' },
			{ name = 'burger-raw',             price = 20,  currency = 'money' },
