return {
	...
	CyberHexOilShop = {
		name = 'CyberHex Oil',
		inventory = {
			{ name = 'cyberoil_orange', price = 250, count = 50 },
			{ name = 'cyberoil_blue',   price = 250, count = 50 },
			{ name = 'cyberoil_green',  price = 250, count = 50 },
	...
	MidnightSun = {
		...
		inventory = {
			...
			{ name = 'cyberoil_blue',   price = 50, count = 50, currency = 'money' },
			{ name = 'cyberoil_green',  price = 50, count = 50, currency = 'money' },
			{ name = 'cyberoil_orange', price = 50, count = 50, currency = 'money' },
