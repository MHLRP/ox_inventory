return {
	...
	GeneralStore = {
		...
		inventory = {
			...
			{ name = 'taco-tomato',            price = 40, count = 75,  currency = 'money' },
			{ name = 'lettuce',                price = 40, count = 75,  currency = 'money' },
			...
			{ name = 'mozzarella',             price = 20, count = 75,  currency = 'money' },
			...
			{ name = 'potato',                 price = 40, count = 75,  currency = 'money' },
			...
			{ name = 'orange',                 price = 45, count = 75,  currency = 'money' },
			{ name = 'grape',                  price = 45, count = 75,  currency = 'money' },
			{ name = 'alfredo',                price = 20, count = 75,  currency = 'money' },
			...
			{ name = 'raw_meat',               price = 20, count = 75,  currency = 'money' },
			{ name = 'meatballs',              price = 20, count = 75,  currency = 'money' },
			{ name = 'veal_meat',              price = 20, count = 75,  currency = 'money' },
			{ name = 'raw_shrimp',             price = 20, count = 75,  currency = 'money' },
			{ name = 'burger-raw',             price = 20, count = 75,  currency = 'money' },
			{ name = 'ground-beef',            price = 20, count = 75,  currency = 'money' },
			{ name = 'chicken',                price = 20, count = 75,  currency = 'money' },
			{ name = 'fishnchipsbreadknife',   price = 2,  count = 100, currency = 'money' },
			{ name = 'fishnchipskitchenknife', price = 2,  count = 100, currency = 'money' },
			{ name = 'milk',                   price = 45, count = 75,  currency = 'money' },
	...
	YouTool = {
		...
		inventory = {
			...
			{ name = 'toolbox',          price = 800,  currency = 'money' },
	...
	YouTool2 = {
		name = 'YouTool Store',
		inventory = {
			{ name = 'duct_tape',        price = 75,  currency = 'money' },
			{ name = 'carradio',         price = 300, currency = 'money' },
			{ name = 'gps',              price = 150, currency = 'money' },
			{ name = 'weapon_petrolcan', price = 100, currency = 'money' },
			{ name = 'toolbox',          price = 800, currency = 'money' },
			{ name = 'cleaning_kit',     price = 75,  count = 25,        currency = 'money' },
			{ name = 'cybernuts',        price = 50,  currency = 'money' },
			{ name = 'cyberoil',         price = 500, currency = 'money' },
			{ name = 'kq_snowchain',     price = 400, currency = 'money' },
		},
		targets = {
			{
				ped = `a_m_m_ktown_01`,
	...
	GroceryStore = {
		name = 'Grocery Store',
		inventory = {
			{ name = 'milk', price = 45, count = 100, currency = 'money' },
		},
		locations = {
	...
	GroceryStore2 = {
		...
		inventory = {
			...
			{ name = 'ground-beef',                price = 20, count = 75, currency = 'money' },
			{ name = 'chicken',                    price = 20, count = 75, currency = 'money' },
			{ name = 'chicken_wings',              price = 20, count = 75, currency = 'money' },
			{ name = 'hotdog',                     price = 10, count = 75, currency = 'money' },
			{ name = 'fishnchipsrawchickenstrips', price = 20, count = 75, currency = 'money' },
			{ name = 'frozen_fishcake',            price = 20, count = 75, currency = 'money' },
			{ name = 'frozen_sausage',             price = 20, count = 75, currency = 'money' },
			{ name = 'frozen_sole_fillet',         price = 20, count = 75, currency = 'money' },
			{ name = 'frozen_pollock_fillet',      price = 20, count = 75, currency = 'money' },
			{ name = 'frozen_plaice_fillet',       price = 20, count = 75, currency = 'money' },
	...
	GroceryStoreFront = {
		...
		inventory = {
			...
			{ name = 'frasco-nutela',          price = 10, count = 75,        currency = 'money' },
			{ name = 'potato',                 price = 40, count = 75,        currency = 'money' },
			{ name = 'snr_onions',             price = 20, currency = 'money' },
			{ name = 'burger-mshakeformula',   price = 10, count = 75,        currency = 'money' },
			{ name = 'burger-sodasyrup',       price = 10, count = 75,        currency = 'money' },
			{ name = 'bhighcoffeeglasscup',    price = 10, count = 75,        currency = 'money' },
			{ name = 'bcoffeeglass',           price = 10, count = 75,        currency = 'money' },
			...
			{ name = 'mushroom',               price = 40, count = 75,        currency = 'money' },
			...
			{ name = 'pineapple',              price = 10, count = 75,        currency = 'money' },
	...
	-- 		{ name = 'bcaramelsyrup',        price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'tortillas',            price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'taco-tomato',          price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'lettuce',              price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'barra-manteiga',       price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'tortilla-chips',       price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'cheddar-cheese',       price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'caixa-amoras',         price = 10,  count = 75, currency = 'money' },
	...
	-- 		{ name = 'bcoffeeglass',         price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'bespressocoffeecup',   price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'orange',               price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'banana',               price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'apple',                price = 10,  count = 75, currency = 'money' },
	...
	-- 		{ name = 'flour',                price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'milk',                 price = 10,  count = 75, currency = 'money' },
	-- 		{ name = 'sandwich',             price = 10,  count = 75, currency = 'money' },
