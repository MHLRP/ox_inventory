return {
	...
	YouTool = {
		...
		inventory = {
			...
			{ name = 'frisbee_r',        price = 400,   currency = 'money' },
			{ name = 'frisbee_g',        price = 400,   currency = 'money' },
			{ name = 'frisbee_b',        price = 400,   currency = 'money' },
			{ name = 'frisbee_y',        price = 400,   currency = 'money' },
